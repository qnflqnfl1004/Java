...
public class A_HashSet {
	...
	public void method1() {
		...
		// 3. HashSet에 저장된 객체들을 ArrayList 에 담아서 사용하는 방법
	...
	public void method2() {
		 ...
		 * Object 클래스에 있는 hashCode(), equals() 메소드는 주소값을 가지고 비교하기 때문에 필드 값과 상관없이
		 * 다른 객체로 인식해서 중복이 제거되지 않는다.
		 * 
		 * Music 클래스에서 hashCode(), equals() 메소드를 재정의 해주어야한다.
		 */
